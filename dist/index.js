...
Please start by enabling the terminal viewer service.`,
    ...
    async restartTerminalViewerService(preserveRunningState = false) {
        ...
        if (this.config.terminalViewer.enabled || (preserveRunningState && wasRunning)) {
            const viewerService = new viewer_service_1.TerminalViewerService({ ...this.config.terminalViewer });
